...
def test_scrape():
    STYLED_TEST_TEXT = (
        "<paper>Hello my name is Daniel, my <italic attr='Whatever' "
        "color = 'Blue'>favorite</italic> chemical is <i>C</i><sub>4</sub>. "
        "<b hello = 'dan' haha = 'whatever'>I</b> also <italic attr "
        "='something'>wanted</italic> to say that <underline>you</underline> "
        "should use this code as a<sup>1</sup> test to make sure "
    ...
    CORRECT_DATA_DICT = {
        "paper": {},
        "italic": {"attr": ["Whatever", "something"], "color": ["Blue"]},
        "i": {},
        "sub": {},
    ...
    trees.visualize_element_tree(
        test_root, title="data/test_text_vis.gv", test_mode=True
    )
