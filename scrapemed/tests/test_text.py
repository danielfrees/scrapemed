"""
Test ScrapeMed's text module.
"""

import scrapemed._text as _text
from scrapemed._text import TextParagraph, TextSection, TextTable

# from scrapemed._text import TextFigure
...
def test_text():
    ...
    text1 = (
        "<sec> <title>Test of the scrapemed._text Module</title> "
        "<p attr='ok'> Testing paragraph 1 </p> <p> Testing paragraph 2 </p> "
        "<sec attr='oksec'><title>Testing Subsection</title><p>Grandchild "
        "test</p> </sec> </sec>"
    )
    ...
    text2 = (
        "<sec> <title>Test of the scrapemed._text Module</title> "
        "<p attr='ok'>Testing <xref>reference <italic>test</italic></xref> "
        "paragraph <italic>1</italic></p> <p> Testing paragraph 2 </p> "
        "<sec attr='oksec'><title>Testing Subsection</title><p>Grandchild "
        "test</p> </sec> </sec>"
    )
    ...
    assert (
        full_test2_p1_subtree_text.strip()
        == (
            "Testing <xref>reference <italic>test</italic></xref> paragraph "
            "<italic>1</italic>"
        ).strip()
    )
